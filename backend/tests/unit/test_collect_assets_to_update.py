...
@pytest.mark.parametrize(
    "new_assets, existing_assets, expected_assets_to_update",
    [
        pytest.param(
            test_new_assets,
            test_existing_assets,
            test_expected_assets_to_update,
            id="update_all_assets",
        ),
...
def test_collect_assets_parametrized(
    new_assets, existing_assets, expected_assets_to_update
):
